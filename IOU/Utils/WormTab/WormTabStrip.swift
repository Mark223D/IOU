...
public struct WormTabStripStylePropertyies {
    ...
    var kHeightOfWormForBubble:CGFloat = 32
    ...
    var tabItemDefaultFont:UIFont = UIFont.systemFont(ofSize: 14)
    var tabItemSelectedFont:UIFont = UIFont.boldSystemFont(ofSize: 18)
    
    /*****
     colors
     ****/
    
    var tabItemDefaultColor:UIColor = .lightGrey
    //UIColor(displayP3Red: 61/255, green: 103/255, blue: 40/255, alpha: 0.7)
    
    var tabItemSelectedColor:UIColor = .green
    
    //color for worm
    var WormColor:UIColor = UIColor.green
    
    var topScrollViewBackgroundColor:UIColor = .mediumGrey
    
    var contentScrollViewBackgroundColor:UIColor = .clear
    
    var dividerBackgroundColor:UIColor = UIColor.clear
