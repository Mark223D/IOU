...
class AmountBtn: UIButton {
  ...
  @IBInspectable public var startColor: UIColor = UIColor.appColor(.tabBarSelected) ?? .clear {
        didSet {
            updateUI()
        }
    }
  ...
  @IBInspectable public var endColor: UIColor = UIColor.appColor(.tabBarSelected) ?? .clear {
        didSet {
            updateUI()
        }
    }
